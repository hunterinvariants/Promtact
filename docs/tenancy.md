...
Promtact uses logical tenant isolation in the application and store layer. For
...
If you need hard separation between tenants, deploy a separate Promtact instance
per tenant:
