...
DEPLOY_TARGET_DIR="${DEPLOY_TARGET_DIR:-/opt/promtact}"
DEPLOY_SERVICE="${DEPLOY_SERVICE:-promtact}"
...
if [ ! -x "$DEPLOY_SOURCE_DIR/promtact" ] || [ ! -x "$DEPLOY_SOURCE_DIR/promtactl" ]; then
...
install -m 0755 "$DEPLOY_SOURCE_DIR/promtact" "$RELEASE_DIR/promtact"
install -m 0755 "$DEPLOY_SOURCE_DIR/promtactl" "$RELEASE_DIR/promtactl"
